...
pub fn get_upgrade_version(config: &Config) -> Option<String> {
    // Aster update checks are opt-in and use this fork's GitHub releases.
...
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/Owen1B/aster/releases/latest";
...
mod tests {
    ...
    fn extracts_version_from_latest_tag() {
        assert_eq!(
            extract_version_from_latest_tag("aster-v1.5.0").expect("failed to parse version"),
            "1.5.0"
        );
    }
