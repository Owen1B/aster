...
- Aster 的 GitHub Release 更新提示默认关闭，不使用官方 Codex 的 npm/Homebrew 更新通道。
...
Linux x86_64 和 macOS 可以直接运行安装脚本：
...
- `ASTER_ENABLE_UPDATE_CHECK`：是否启用 Aster GitHub Release 更新检查，默认关闭。
- `ASTER_ENABLE_ANNOUNCEMENTS`：是否启用 Aster 公告提示，默认关闭。
